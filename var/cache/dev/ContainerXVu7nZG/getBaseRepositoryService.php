 ...
 */
class getBaseRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BaseRepository.php';

        return $container->privates['App\\Repository\\BaseRepository'] = new \App\Repository\BaseRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
